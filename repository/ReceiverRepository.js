...
var createNewReceiver = function(receiver, callback){
    ...
    dbPool.getConnection(function(err,connection){
    	connection.query("insert into receiver (receiver_id, api_key, username, dash_payment_address, amount_fiat, type_fiat, base_fiat, amount_duffs, created_date, description, callback_url) values (?,?,?,?,?,?,?,?,NOW(),?, ?)",
            [receiver.receiver_id, receiver.api_key, receiver.username, receiver.dash_payment_address, receiver.amount_fiat, receiver.type_fiat, receiver.base_fiat, receiver.amount_duffs, receiver.description, receiver.callback_url], function(err,results){
        		connection.release();
...
var getUnpaid = function(callback){
	dbPool.getConnection(function(err,connection){
		connection.query("select receiver_id, api_key, username, dash_payment_address, amount_fiat, type_fiat, base_fiat, amount_duffs, payment_received_amount_duffs, created_date, description, callback_url from receiver where payment_received_amount_duffs is null or payment_received_amount_duffs < amount_duffs",
